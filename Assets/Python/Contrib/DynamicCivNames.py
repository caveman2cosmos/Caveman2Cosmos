...
class DynamicCivNames:
	...
	def setNewNameByCivics(self, iPlayer):
		...
		newDesc	= CvUtil.remove_diacriticals(newCivDesc)
		newShort = CvUtil.remove_diacriticals(newCivShort)
		newAdj	 = CvUtil.remove_diacriticals(newCivAdj)
		print ("WAKA", gc.getPlayer(iPlayer).getCivilizationDescription(0))
	...
	def resetName(self, iPlayer, bVerbose = True):
		...
		newDesc	= CvUtil.remove_diacriticals(origDesc)
		newShort = CvUtil.remove_diacriticals(origShort)
		newAdj	 = CvUtil.remove_diacriticals(origAdj)

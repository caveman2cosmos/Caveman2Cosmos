...
class BuildListScreen:
  ...
  def drawBuilds(self):
    ...
    screen.addPullDownString( "UnitSorting", localText.getText("TXT_KEY_NAME", ()), UnitSortTypes.UNIT_SORT_NAME, UnitSortTypes.UNIT_SORT_NAME, iSelectedSorting == UnitSortTypes.UNIT_SORT_NAME)
    screen.addPullDownString( "UnitSorting", localText.getText("TXT_KEY_COST", ()), UnitSortTypes.UNIT_SORT_COST, UnitSortTypes.UNIT_SORT_COST, iSelectedSorting == UnitSortTypes.UNIT_SORT_COST)
    ...
    screen.addPullDownString( "UnitSorting", localText.getText("TXT_KEY_CARGO", ()), UnitSortTypes.UNIT_SORT_CARGO, UnitSortTypes.UNIT_SORT_CARGO, iSelectedSorting == UnitSortTypes.UNIT_SORT_CARGO)
    ...
    screen.addPullDownString("BuildingSorting", localText.getText("TXT_KEY_NAME", ()), BuildingSortTypes.BUILDING_SORT_NAME, BuildingSortTypes.BUILDING_SORT_NAME, iSelectedSorting == BuildingSortTypes.BUILDING_SORT_NAME)
    screen.addPullDownString("BuildingSorting", localText.getText("TXT_KEY_COST", ()), BuildingSortTypes.BUILDING_SORT_COST, BuildingSortTypes.BUILDING_SORT_COST, iSelectedSorting == BuildingSortTypes.BUILDING_SORT_COST)
    ...
    screen.addPullDownString("BuildingSorting", localText.getText("TXT_KEY_ESPIONAGE", ()), BuildingSortTypes.BUILDING_SORT_ESPIONAGE, BuildingSortTypes.BUILDING_SORT_ESPIONAGE, iSelectedSorting == BuildingSortTypes.BUILDING_SORT_ESPIONAGE)
    screen.addPullDownString("BuildingSorting", localText.getText("TXT_KEY_CULTURE", ()), BuildingSortTypes.BUILDING_SORT_CULTURE, BuildingSortTypes.BUILDING_SORT_CULTURE, iSelectedSorting == BuildingSortTypes.BUILDING_SORT_CULTURE)
    ...
    screen.addPullDownString("BuildingSorting", localText.getText("TXT_KEY_FOOD", ()), BuildingSortTypes.BUILDING_SORT_FOOD, BuildingSortTypes.BUILDING_SORT_FOOD, iSelectedSorting == BuildingSortTypes.BUILDING_SORT_FOOD)

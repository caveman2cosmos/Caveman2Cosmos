...
class TestCode:
	...
	def checkBuildingReplacementObsoletion(self):
		aSpecialReplacementsList = [GC.getInfoTypeForString("BUILDING_POLLUTION_BLACKENEDSKIES"), GC.getInfoTypeForString("BUILDING_ORDINANCE_GAMBLING_BAN"), GC.getInfoTypeForString("BUILDING_ORDINANCE_ALCOHOL_PROHIBITION"), GC.getInfoTypeForString("BUILDING_ORDINANCE_DRUG_PROHIBITION"), GC.getInfoTypeForString("BUILDING_ORDINANCE_PROSTITUTION_BAN")]
	...
	def checkBuildingReplacingQuality(self):
		aSpecialBuildingsList = [GC.getInfoTypeForString("BUILDING_POLLUTION_BLACKENEDSKIES"), GC.getInfoTypeForString("BUILDING_ORDINANCE_GAMBLING_BAN"), GC.getInfoTypeForString("BUILDING_ORDINANCE_ALCOHOL_PROHIBITION"), GC.getInfoTypeForString("BUILDING_ORDINANCE_DRUG_PROHIBITION"), GC.getInfoTypeForString("BUILDING_ORDINANCE_PROSTITUTION_BAN")]
		for iBuilding in xrange(GC.getNumBuildingInfos()):
			CvBuildingInfo = GC.getBuildingInfo(iBuilding)
	...
	def listStandaloneBuildings(self):
		aSpecialReplacementsList = ["BUILDING_POLLUTION_BLACKENEDSKIES", "BUILDING_ORDINANCE_GAMBLING_BAN", "BUILDING_ORDINANCE_ALCOHOL_PROHIBITION", "BUILDING_ORDINANCE_DRUG_PROHIBITION", "BUILDING_ORDINANCE_PROSTITUTION_BAN"]

...
if (!$gitexe) {
    ...
    if([Environment]::Is64BitOperatingSystem) {
        ...
        & ".\Utils\wget.exe" -O "git_installer.exe" "hhttps://github.com/git-for-windows/git/releases/download/v2.37.0.windows.1/Git-2.37.0-32-bit.exe" --quiet --show-progress
    }

...
//
//
//void CvPythonInfoLoader::CyInfoPythonInterface1()
//{
//	OutputDebugString("Python Extension Module - CyInfoPythonInterface1\n");
//
//	boost::python::class_<CvInfoBase>("CvInfoBase", boost::python::no_init)
//
...
//		;
//
//	boost::python::class_<CvScalableInfo>("CvScalableInfo", boost::python::no_init)
//		.def("getScale", &CvScalableInfo::getScale, "float ()")
//		;
//
//	boost::python::class_<CvSpecialistInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvSpecialistInfo", boost::python::no_init)
//
...
//	;
//
//	boost::python::class_<CvTechInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvTechInfo", boost::python::no_init)
...
//		.def("getPrereqOrTechs", &CvTechInfo::getPrereqOrTechs, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getPrereqAndTechs", &CvTechInfo::getPrereqAndTechs, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//		;
//
//	boost::python::class_<CvPromotionInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvPromotionInfo", boost::python::no_init)
//
...
//		;
//
//	boost::python::class_<CvMissionInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvMissionInfo", boost::python::no_init)
...
//		;
//
//	boost::python::class_<CvActionInfo, boost::noncopyable>("CvActionInfo", boost::python::no_init)
//		.def("getButton", &CvActionInfo::getButton, "string ()")
//		;
//
//	boost::python::class_<CvUnitInfo, boost::python::bases<CvInfoBase, CvScalableInfo>, boost::noncopyable>("CvUnitInfo", boost::python::no_init)
...
//
//		// Arrays
//		.def("getPrereqAndTechs", &CvUnitInfo::getPrereqAndTechs, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getPrereqOrBonuses", &CvUnitInfo::getPrereqOrBonuses, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//		.def("getArtInfo", &CvUnitInfo::getArtInfo,  boost::python::return_value_policy<boost::python::reference_existing_object>(), "CvArtInfoUnit* (int i, bool bLate)")
...
//
//		.def("getMapCategories", &CvUnitInfo::getMapCategories, boost::python::return_value_policy<boost::python::reference_existing_object>())
//
//		.def("getTrainCondition", &CvUnitInfo::getTrainCondition, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		;
//
//	boost::python::class_<CvSpecialUnitInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvSpecialUnitInfo", boost::python::no_init)
//		.def("isValid", &CvSpecialUnitInfo::isValid, "bool ()")
//		;
//
//	boost::python::class_<CvCivicOptionInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvCivicOptionInfo", boost::python::no_init)
//		//.def("getTraitNoUpkeep", &CvCivicOptionInfo::getTraitNoUpkeep, "bool (int i)")
//		;
//
//	boost::python::class_<CvCivicInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvCivicInfo", boost::python::no_init)
//
...
//		;
//
//	boost::python::class_<CvBuildingInfo, boost::python::bases<CvInfoBase, CvScalableInfo>, boost::noncopyable>("CvBuildingInfo", boost::python::no_init)
//
...
//		.def("getFreeBonuses", &CvBuildingInfo::getFreeBonuses, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//		.def("getUnitCombatFreeExperience", &CvBuildingInfo::getUnitCombatFreeExperience, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getHealUnitCombatType", &CvBuildingInfo::getHealUnitCombatType, boost::python::return_value_policy<boost::python::reference_existing_object>(), "int (int i)")
...
//		.def("getUnitCombatExtraStrength", &CvBuildingInfo::getUnitCombatExtraStrength, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getUnitCombatProdModifier", &CvBuildingInfo::getUnitCombatProdModifier, "int (int i)")
//		.def("getPrereqAndTechs", &CvBuildingInfo::getPrereqAndTechs, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getPrereqOrBonuses", &CvBuildingInfo::getPrereqOrBonuses, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getPrereqOrVicinityBonuses", &CvBuildingInfo::getPrereqOrVicinityBonuses, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getPrereqOrRawVicinityBonuses", &CvBuildingInfo::getPrereqOrRawVicinityBonuses, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getTechHappinessChanges", &CvBuildingInfo::getTechHappinessChanges, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getTechHealthChanges", &CvBuildingInfo::getTechHealthChanges, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//		.def("getBonusHealthChanges", &CvBuildingInfo::getBonusHealthChanges, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getBonusHappinessChanges", &CvBuildingInfo::getBonusHappinessChanges, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//
//		.def("getPrereqNumOfBuildings", &CvBuildingInfo::getPrereqNumOfBuildings, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getFlavorValue", &CvBuildingInfo::getFlavorValue, "int (int i)")
//		.def("getImprovementFreeSpecialists", &CvBuildingInfo::getImprovementFreeSpecialists, boost::python::return_value_policy<boost::python::reference_existing_object>())
//
//		.def("getGlobalBuildingCostModifiers", &CvBuildingInfo::getGlobalBuildingCostModifiers, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getGlobalBuildingCommerceChanges", &CvBuildingInfo::cyGetGlobalBuildingCommerceChanges)
//		.def("getGlobalBuildingProductionModifiers", &CvBuildingInfo::getGlobalBuildingProductionModifiers, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getBuildingHappinessChanges", &CvBuildingInfo::getBuildingHappinessChanges, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getBuildingProductionModifiers", &CvBuildingInfo::getBuildingProductionModifiers, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		.def("getUnitProductionModifiers", &CvBuildingInfo::getUnitProductionModifiers, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//
//		.def("getPrereqOrImprovements", &CvBuildingInfo::getPrereqOrImprovements, boost::python::return_value_policy<boost::python::reference_existing_object>())
...
//
//		.def("getMapCategories", &CvBuildingInfo::getMapCategories, boost::python::return_value_policy<boost::python::reference_existing_object>())
//
//		.def("getProperties", &CvBuildingInfo::getProperties, boost::python::return_value_policy<boost::python::reference_existing_object>(), "CvProperties ()")
//		.def("getPropertyManipulators", &CvBuildingInfo::getPropertyManipulators, boost::python::return_value_policy<boost::python::reference_existing_object>())
//
//		.def("getConstructCondition", &CvBuildingInfo::getConstructCondition, boost::python::return_value_policy<boost::python::reference_existing_object>())
//		;
//
//	boost::python::class_<CvSpecialBuildingInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvSpecialBuildingInfo", boost::python::no_init)
...
//		;
//
//	boost::python::class_<CvPromotionLineInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvPromotionLineInfo", boost::python::no_init)
...
//		;
//
//	boost::python::class_<CvUnitCombatInfo, boost::python::bases<CvInfoBase>, boost::noncopyable>("CvUnitCombatInfo", boost::python::no_init)

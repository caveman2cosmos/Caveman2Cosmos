...
class PromotionKeyedInfo
{
  public:
	PromotionKeyedInfo()
		: m_bHasPromotion(false), m_iAfflictOnAttackCount(0), m_iCureAfflictionCount(0), m_iAfflictionTurnCount(0), m_iAfflictionHitCount(0), m_iAfflictionTolerance(0), m_iFortitudeModifierTypeAmount(0), m_iPromotionFreeCount(0), m_iTrapSetWithPromotionCount(0), m_iPromotionFromTraitCount(0)
	{
	}
...
{
  public:
	PromotionLineKeyedInfo()
		: m_iCureAfflictionTypeCount(0), m_iAfflictionTurnTypeCount(0), m_iAfflictionLineCount(0), m_iAfflictionTypeTolerance(0), m_iFortitudeModifierAmount(0), m_iAfflictOnAttackTypeProbability(0), m_iAfflictOnAttackTypeCount(0), m_iAfflictOnAttackTypeImmediateCount(0), m_iAfflictOnAttackTypeAttemptedCount(0), m_iDistanceAttackCommunicability(0), m_bValidBuildUp(false), m_iAfflictOnAttackTypeMeleeCount(0), m_iAfflictOnAttackTypeDistanceCount(0)
	{
	}
...
class TerrainKeyedInfo
{
  public:
	TerrainKeyedInfo()
		: m_iTerrainProtected(0), m_iTerrainDoubleMoveCount(0), m_iExtraTerrainAttackPercent(0), m_iExtraTerrainDefensePercent(0), m_iTerrainWorkPercent(0),
		//Team Project (4)
		//WorkRateMod
...
class FeatureKeyedInfo
{
  public:
	FeatureKeyedInfo()
		: m_iFeatureDoubleMoveCount(0), m_iExtraFeatureAttackPercent(0), m_iExtraFeatureDefensePercent(0), m_iFeatureWorkPercent(0),
		//Team Project (4)
		//WorkRateMod
...
class UnitCombatKeyedInfo
{
  public:
	UnitCombatKeyedInfo()
		: m_bHasUnitCombat(false), m_iExtraUnitCombatModifier(0), m_iSubCombatTypeCount(0), m_iOngoingTrainingCount(0), m_iRemovesUnitCombatTypeCount(0), m_iExtraFlankingStrengthbyUnitCombatType(0), m_iExtraWithdrawVSUnitCombatType(0), m_iExtraPursuitVSUnitCombatType(0), m_iExtraRepelVSUnitCombatType(0), m_iExtraKnockbackVSUnitCombatType(0), m_iExtraPunctureVSUnitCombatType(0), m_iExtraArmorVSUnitCombatType(0), m_iExtraDodgeVSUnitCombatType(0), m_iExtraPrecisionVSUnitCombatType(0), m_iExtraCriticalVSUnitCombatType(0), m_iExtraRoundStunVSUnitCombatType(0), m_iHealUnitCombatTypeVolume(0), m_iHealUnitCombatTypeAdjacentVolume(0), m_iHealAsDamage(0), m_iTrapImmunityUnitCombatCount(0), m_iTargetUnitCombatCount(0), m_iExtraTrapDisableUnitCombatType(0), m_iExtraTrapAvoidanceUnitCombatType(0), m_iExtraTrapTriggerUnitCombatType(0)
	{
	}

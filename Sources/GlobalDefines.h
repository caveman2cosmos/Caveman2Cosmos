...
#define DO_FOR_EACH_INT_GLOBAL_DEFINE(DO) \
	DO(int, EMERGING_MINOR_CIV_GOLDEN_AGE_TURNS) \
	...
	DO(int, INITIAL_BASE_FREE_MILITARY_UNITS) \
	DO(int, INITIAL_BASE_FREE_UNITS) \
	DO(int, INITIAL_CITY_POPULATION) \
	DO(int, INITIAL_FREE_MILITARY_UNITS_POPULATION_PERCENT) \
	DO(int, INITIAL_FREE_UNITS_POPULATION_PERCENT) \
	DO(int, INITIAL_GOLD_PER_UNIT) \

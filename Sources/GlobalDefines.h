...
#define DO_FOR_EACH_INT_GLOBAL_DEFINE(DO) \
	...
	DO(int, FIRE_EVENT_RAND) \
	DO(int, FIRE_MIN_FLAMMABILITY) \
	DO(int, FIRE_MAJOR_FLAMMABILITY) \
	DO(int, FIRE_CATASTROPHIC_FLAMMABILITY) \
	DO(int, FIRE_MAJOR_CHANCE_PERCENT) \
	DO(int, FIRE_CATASTROPHIC_CHANCE_PERCENT) \
	DO(int, FIRE_EFFECT_DURATION_TURNS) \
	...
	DO(int, BUILDINGCOST_SIZE_SMALL_PERCENT) \
	DO(int, BUILDINGCOST_SIZE_BIG_PERCENT) \
	DO(int, BUILDINGCOST_SIZE_HUGE_PERCENT) \
	DO(int, BUILDINGCOST_COUNT_ONE_PERCENT) \
	DO(int, BUILDINGCOST_COUNT_MANY_PERCENT) \
	DO(int, BUILDINGCOST_MATERIALS_CHEAP_PERCENT) \
	DO(int, BUILDINGCOST_MATERIALS_EXPENSIVE_PERCENT) \
	DO(int, BUILDINGCOST_COMPLEXITY_SIMPLE_PERCENT) \
	DO(int, BUILDINGCOST_COMPLEXITY_COMPLEX_PERCENT) \

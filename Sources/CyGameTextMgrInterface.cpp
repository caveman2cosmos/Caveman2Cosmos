...
void CyGameTextMgrInterface()
{
	...
	python::class_<CyGameTextMgr>("CyGameTextMgr")
		...
		.def("getHeritageHelp", &CyGameTextMgr::getHeritageHelp, "wstring (int iType, CyCity* pCity, bool bCivilopediaText, bool bStrategyText, bool bTechChooserText)")
		...
		.def("parseLeaderTraits", &CyGameTextMgr::parseLeaderTraits, "wstring (int /*LeaderHeadTypes*/ iLeader, bool bDawnOfMan, bool bCivilopediaText)")
		.def("parseTraits", &CyGameTextMgr::parseTraits, "wstring (int /*TraitTypes*/ eTrait, bool bDawnOfMan, boolbEffectsOnly)")
		...
		.def("getFlagHelp", &CyGameTextMgr::getFlagHelp, "wstring ()")
	;
}

...
public:
	...
	virtual bool LoadXml(FXml* xml, const char* pszXmlFile) = 0;
	...
	virtual bool LocateNode(FXml* xml, const char* pszXmlNode) = 0;
	...
	virtual bool SetToChildByTagName(FXml* xml, const char* szTagName) = 0;
	...
	virtual int NumOfChildrenByTagName(FXml* xml, const char* pszTagName) = 0;

...
class StreamWrapper : public FDataStreamBase
{
  public:
	...
	{
		return m_wrapped->ReadString(szName);
		m_lenRead += strlen(szName);
	}
	virtual unsigned int ReadString(wchar* szName)
	{
		return m_wrapped->ReadString(szName);
		m_lenRead += wcslen(szName);
	}
	virtual unsigned int ReadString(std::string& szName)
	{
		return m_wrapped->ReadString(szName);
		m_lenRead += szName.length();
	}
	virtual unsigned int ReadString(std::wstring& szName)
	{
		return m_wrapped->ReadString(szName);
		m_lenRead += 2 * szName.length();
	}
	virtual unsigned int ReadString(int count, std::string values[])
	{
		return m_wrapped->ReadString(count, values);
		m_lenRead += count * values[0].length();
	}
	virtual unsigned int ReadString(int count, std::wstring values[])
	{
		return m_wrapped->ReadString(count, values);
		m_lenRead += 2 * count * values[0].length();
	}

	virtual char* ReadString()
	{
		char* result = m_wrapped->ReadString();
		m_lenRead += (result == NULL ? 0 : strlen(result));
		return result;
	}
	virtual wchar* ReadWideString()
	{
		wchar* result = m_wrapped->ReadWideString();
		m_lenRead += (result == NULL ? 0 : 2 * wcslen(result));
		return result;
	}
	...
	{
		m_wrapped->Read(value);
		m_lenRead += sizeof(float);
	}
	virtual void Read(int count, float values[])
	{
		m_wrapped->Read(count, values);
		m_lenRead += count * sizeof(float);
	}

	virtual void Read(double* value)
	{
		m_wrapped->Read(value);
		m_lenRead += sizeof(double);
	}
	virtual void Read(int count, double values[])
	{
		m_wrapped->Read(count, values);
		m_lenRead += count * sizeof(double);
	}
...
void CvTaggedSaveFormatWrapper::reset(bool useTaggedFormat)
{
	usageSeq++;
	lastIdMatch = -1;
...
void CvTaggedSaveFormatWrapper::AttachToStream(FDataStreamBase* pStream)
{
#ifdef TEMP_DEBUGGING_SUPPORT
...
void CvTaggedSaveFormatWrapper::WriteObjectDelimiter(const char* name, int& idHint, int& idSeq, bool bStart)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteClassMappingTable(RemappedClassType classType)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteClassMappingTables()
{
	PROFILE_FUNC();
...
int CvTaggedSaveFormatWrapper::getNumClassEnumValues(RemappedClassType classType)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteStartObject(const char* name, int& idHint, int& idSeq)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteEndObject()
{
	int dummy;
...
void CvTaggedSaveFormatWrapper::WriteClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int value)
{
	PROFILE_FUNC();
...
//	The following methods must be used for entities that correspond to class enums
void CvTaggedSaveFormatWrapper::WriteClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType classType, short value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteClassArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, const int values[])
{
	PROFILE_FUNC();
...
//	The following are for arrays whose index is a class enum value
void CvTaggedSaveFormatWrapper::WriteClassArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, const bool values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteClassArrayOfClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType indexClassType, RemappedClassType valueClassType, int count, const int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteClassEnumArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, short values[])
{
	PROFILE_FUNC();
...
//	Array whose values are class enum entities
void CvTaggedSaveFormatWrapper::WriteClassEnumArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, char value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, byte value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const char values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const byte values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, bool value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const bool values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, short value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, unsigned short value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const short values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const unsigned short values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, unsigned int value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const unsigned int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, long value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, unsigned long value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const long values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const unsigned long values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, float value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const float values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, double value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Write(const char* name, int& idHint, int& idSeq, int count, const double values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, const wchar* szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, const char* szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, const std::string& szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, const std::wstring& szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, int count, std::string values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::WriteString(const char* name, int& idHint, int& idSeq, int count, std::wstring values[])
{
	PROFILE_FUNC();
...
int CvTaggedSaveFormatWrapper::getId(const char* name, int& idHint, int& idSeq, SaveValueType type, bool addToDictionary)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, char** szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, wchar** szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, std::string& szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, std::wstring& szName)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, int count, std::string values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadString(const char* name, int& idHint, int& idSeq, int count, std::wstring values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, char* pChar)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, byte* pByte)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, char values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, byte values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, bool* pBool)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, bool values[], bool bAllowTruncation)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, short* s)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, unsigned short* s)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, short values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, unsigned short values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int* i)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, unsigned int* i)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, unsigned int values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, long* l)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, unsigned long* l)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, long values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, unsigned long values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, float* value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, float values[])
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, double* value)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::Read(const char* name, int& idHint, int& idSeq, int count, double values[])
{
	PROFILE_FUNC();
...
//	The following methods must be used for entities that correspond to class enums
void CvTaggedSaveFormatWrapper::ReadClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int* value, bool allowMissing)
{
	PROFILE_FUNC();
...
//	The following methods must be used for entities that correspond to class enums
void CvTaggedSaveFormatWrapper::ReadClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType classType, short* value, bool allowMissing)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadClassArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, int values[], bool allowMissing, bool allowRawArray)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadClassArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, bool values[], bool allowMissing, bool allowRawArray)
{
	PROFILE_FUNC();
...
//	The following are for arrays whose index is a class enum value and value is another class enum value
void CvTaggedSaveFormatWrapper::ReadClassArrayOfClassEnum(const char* name, int& idHint, int& idSeq, RemappedClassType indexClassType, RemappedClassType valueClassType, int count, int values[])
{
	PROFILE_FUNC();
...
//	The following methods must be used for entities that correspond to class enums
void CvTaggedSaveFormatWrapper::ReadClassEnumArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, short values[], bool allowMissing)
{
	PROFILE_FUNC();
...
//	The following methods must be used for entities that correspond to class enums
void CvTaggedSaveFormatWrapper::ReadClassEnumArray(const char* name, int& idHint, int& idSeq, RemappedClassType classType, int count, int values[], bool allowMissing)
{
	PROFILE_FUNC();
...
bool CvTaggedSaveFormatWrapper::Expect(const char* name, int& idHint, int& idSeq, SaveValueType type)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ConsumeBytes(int numBytes)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::SkipElement(const char* name, int& idHint, int& idSeq, SaveValueType saveType)
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::SkipElement()
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadDictionaryElement()
{
	int dummy = -1;
...
void CvTaggedSaveFormatWrapper::ReadClassMap()
{
	PROFILE_FUNC();
...
void CvTaggedSaveFormatWrapper::ReadObjectDelimiter()
{
	PROFILE_FUNC();
...
//	the save & reload
char* CvTaggedSaveFormatWrapper::NormalizeName(const char* name)
{
...
void CvTaggedSaveFormatWrapper::RemoveArrayIndices(char* str, char* brace)
{
...
void CvTaggedSaveFormatWrapper::HandleIncompatibleSave(const char* reason)
{
...
void CvTaggedSaveFormatWrapper::HandleRecoverableIncompatibleSave(const char* reason)
{
	m_warnings.push_back(CvWString(reason));
}

//	Methods to allow warnings and errors associated with the load/save to be reported
void CvTaggedSaveFormatWrapper::warning(const char* msg)
{
	HandleRecoverableIncompatibleSave(msg);
}

void CvTaggedSaveFormatWrapper::error(const char* msg) //	Will terminate the app with a thrown exceptionm after displaying the message
{
	HandleIncompatibleSave(msg);
}

void CvTaggedSaveFormatWrapper::close()
{
	if (m_inUse)
	{

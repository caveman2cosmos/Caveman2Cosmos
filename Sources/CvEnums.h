...
enum GameOptionTypes
{
	...
	GAMEOPTION_REALTIME_EVENT_LOGGING
};
...
// Realistic Building Cost - per-building categorical cost modifiers
// any additions need to be reflected in GlobalTypes.xml
enum BuildingCostSizeTypes
{
	NO_BUILDINGCOSTSIZE = -1,

	BUILDINGCOSTSIZE_SMALL,
	BUILDINGCOSTSIZE_MEDIUM,
	BUILDINGCOSTSIZE_BIG,
	BUILDINGCOSTSIZE_HUGE,

	NUM_BUILDINGCOSTSIZE_TYPES
};

enum BuildingCostCountTypes
{
	NO_BUILDINGCOSTCOUNT = -1,

	BUILDINGCOSTCOUNT_ONE,
	BUILDINGCOSTCOUNT_FEW,
	BUILDINGCOSTCOUNT_MANY,

	NUM_BUILDINGCOSTCOUNT_TYPES
};

enum BuildingCostMaterialsTypes
{
	NO_BUILDINGCOSTMATERIALS = -1,

	BUILDINGCOSTMATERIALS_CHEAP,
	BUILDINGCOSTMATERIALS_NORMAL,
	BUILDINGCOSTMATERIALS_EXPENSIVE,

	NUM_BUILDINGCOSTMATERIALS_TYPES
};

enum BuildingCostComplexityTypes
{
	NO_BUILDINGCOSTCOMPLEXITY = -1,

	BUILDINGCOSTCOMPLEXITY_SIMPLE,
	BUILDINGCOSTCOMPLEXITY_NORMAL,
	BUILDINGCOSTCOMPLEXITY_COMPLEX,

	NUM_BUILDINGCOSTCOMPLEXITY_TYPES
};

...
void CyEnumsPythonInterface()
{
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_UNSUPPORTED_ADVANCED_START", GAMEOPTION_UNSUPPORTED_ADVANCED_START)
		...
		.value("GAMEOPTION_UNIT_ONGOING_TRAINING", GAMEOPTION_UNIT_ONGOING_TRAINING)

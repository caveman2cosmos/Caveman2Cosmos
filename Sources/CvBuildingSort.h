...
{
  public:
	BuildingSortHappiness(bool bInvert = false)
...
{
  public:
	BuildingSortHealth(bool bInvert = false)
		: BuildingSortBase(bInvert){};
	int getBuildingValue(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingSortCost(bool bInvert = false)
		: BuildingSortBase(bInvert){};
	int getBuildingValue(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingSortName(bool bInvert = false)
		: BuildingSortBase(bInvert){};
...
{
  public:
	explicit BuildingSortProperty(PropertyTypes eProperty, bool bInvert = false)
		: BuildingSortBase(bInvert), m_eProperty(eProperty){};
	int getBuildingValue(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
...
{
  public:
	explicit BuildingSortListWrapper(BuildingSortList* pList)
		: m_pList(pList) {}

...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("calculateWFLResearchModifier", &CyPlayer::calculateWFLResearchModifier, "int (int /*TechTypes*/ eTech)")
		.def("calculateTDResearchModifier", &CyPlayer::calculateTDResearchModifier, "int (int /*TechTypes*/ eTech)")
		.def("getNationalTechResearchModifier", &CyPlayer::getNationalTechResearchModifier, "int (int /*TechTypes*/ eTech)")

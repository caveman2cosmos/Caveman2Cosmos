...
// BUG - Fractional Trade Routes - end
		...
		.def("getBuildingProgress", &CyCity::getBuildingProgress, "int (BuildingID) - current production towards BuildingID")
		.def("setBuildingProgress", &CyCity::setBuildingProgress, "void (BuildingID, iNewValue) - set progress towards BuildingID as iNewValue")

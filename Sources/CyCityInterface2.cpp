...
// BUG - Fractional Trade Routes - end
		...
		.def("getNumActiveBuilding", &CyCity::getNumActiveBuilding, "int (BuildingID) - get # Filters out disabled and obsolete buildings")
		.def("getNumBuilding", &CyCity::getNumBuilding, "int (BuildingID) - get # Filters out disabled buildings")

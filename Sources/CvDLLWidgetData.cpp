...
// BUG - Building Saved Maintenance - start
			if (pHeadSelectedCity->getOwnerINLINE() == GC.getGame().getActivePlayer() && GC.getBugOptionBOOL("MiscHover__BuildingSavedMaintenance", true, "BUG_BUILDING_SAVED_MAINTENANCE_HOVER"))
			{
...
// BUG - Building Additional Health - start
		if (pHeadSelectedCity->getOwnerINLINE() == GC.getGame().getActivePlayer() && GC.getBugOptionBOOL("MiscHover__BuildingAdditionalHealth", true, "BUG_BUILDING_ADDITIONAL_HEALTH_HOVER"))
		{

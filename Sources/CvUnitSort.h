...
{
  public:
	UnitSortStrength(bool bInvert = false)
		: UnitSortBase(bInvert){};
...
{
  public:
	UnitSortMove(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortCollateral(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortRange(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortBombard(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortCargo(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortWithdrawal(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortPower(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortCost(bool bInvert = false)
		: UnitSortBase(bInvert){};
	int getUnitValue(CvPlayer* pPlayer, CvCity* pCity, UnitTypes eUnit);
};
...
{
  public:
	UnitSortName(bool bInvert = false)
		: UnitSortBase(bInvert){};
...
{
  public:
	explicit UnitSortListWrapper(UnitSortList* pList)
		: m_pList(pList) {}

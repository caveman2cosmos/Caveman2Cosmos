...
{
  public:
	BuildingFilterCanBuild(bool bShowSomeUnconstructable = false, bool bInvert = false)
		: BuildingFilterBase(bInvert), m_bShowSomeUnconstructable(bShowSomeUnconstructable){};
...
{
  public:
	BuildingFilterIsWonder(bool bInvert = false)
...
{
  public:
	BuildingFilterIsGreatWonder(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsNationalWonder(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsHappiness(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsHealth(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsUnhappiness(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsUnhealthiness(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsMilitary(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	BuildingFilterIsCityDefense(bool bInvert = false)
		: BuildingFilterBase(bInvert){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);
};
...
{
  public:
	explicit BuildingFilterIsProperty(PropertyTypes eProperty, bool bInvert = false)
		: BuildingFilterBase(bInvert), m_eProperty(eProperty){};
	bool isFilteredBuilding(CvPlayer* pPlayer, CvCity* pCity, BuildingTypes eBuilding);

...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("onFinalInitialized", &CyGame::onFinalInitialized, "void (bool bNewGame) - dll is poor at homing in on this game event (i.e. new game + load save), so python will notify it.")

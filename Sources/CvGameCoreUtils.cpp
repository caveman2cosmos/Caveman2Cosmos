...
void getMissionTypeString(CvWString& szString, MissionTypes eMissionType)
{
	...
	case MISSION_GO_TO_MAP_MOON: szString = L"MISSION_GO_TO_MAP_MOON"; break;
	case MISSION_GO_TO_MAP_MARS: szString = L"MISSION_GO_TO_MAP_MARS"; break;
	case MISSION_GO_TO_MAP_VENUS: szString = L"MISSION_GO_TO_MAP_VENUS"; break;
	case MISSION_GO_TO_MAP_INNER_SOLAR_SYSTEM: szString = L"MISSION_GO_TO_MAP_INNER_SOLAR_SYSTEM"; break;
	case MISSION_GO_TO_MAP_OUTER_SOLAR_SYSTEM: szString = L"MISSION_GO_TO_MAP_OUTER_SOLAR_SYSTEM"; break;
	case MISSION_GO_TO_MAP_TITAN: szString = L"MISSION_GO_TO_MAP_TITAN"; break;
	case MISSION_GO_TO_MAP_TRANSNEPTUNIAN: szString = L"MISSION_GO_TO_MAP_TRANSNEPTUNIAN"; break;
	case MISSION_GO_TO_MAP_NEARBY_STARS: szString = L"MISSION_GO_TO_MAP_NEARBY_STARS"; break;
	case MISSION_GO_TO_MAP_ORION_ARM: szString = L"MISSION_GO_TO_MAP_ORION_ARM"; break;
	case MISSION_GO_TO_MAP_MILKY_WAY: szString = L"MISSION_GO_TO_MAP_MILKY_WAY"; break;
	case MISSION_GO_TO_MAP_LOCAL_GROUP: szString = L"MISSION_GO_TO_MAP_LOCAL_GROUP"; break;
	case MISSION_GO_TO_MAP_VIRGO_SUPERCLUSTER: szString = L"MISSION_GO_TO_MAP_VIRGO_SUPERCLUSTER"; break;
	case MISSION_GO_TO_MAP_UNIVERSE: szString = L"MISSION_GO_TO_MAP_UNIVERSE"; break;
	case MISSION_GO_TO_MAP_DISTANT_COSMOS: szString = L"MISSION_GO_TO_MAP_DISTANT_COSMOS"; break;
#endif

...
void getMissionTypeString(CvWString& szString, MissionTypes eMissionType)
{
	...
	case MISSION_GO_TO_MAP_SUBTERRANEAN: szString = L"MISSION_GO_TO_MAP_SUBTERRANEAN"; break;
	case MISSION_GO_TO_MAP_AQUATIC: szString = L"MISSION_GO_TO_MAP_AQUATIC"; break;
	case MISSION_GO_TO_MAP_CISLUNAR: szString = L"MISSION_GO_TO_MAP_CISLUNAR"; break;
	case MISSION_GO_TO_MAP_LUNAR: szString = L"MISSION_GO_TO_MAP_LUNAR"; break;
	case MISSION_GO_TO_MAP_SOLAR_SYSTEM: szString = L"MISSION_GO_TO_MAP_SOLAR_SYSTEM"; break;
	case MISSION_GO_TO_MAP_MARTIAN: szString = L"MISSION_GO_TO_MAP_MARTIAN"; break;
	case MISSION_GO_TO_MAP_VENUSIAN: szString = L"MISSION_GO_TO_MAP_VENUSIAN"; break;
	case MISSION_GO_TO_MAP_JOVIAN: szString = L"MISSION_GO_TO_MAP_JOVIAN"; break;
	case MISSION_GO_TO_MAP_TITANIC: szString = L"MISSION_GO_TO_MAP_TITANIC"; break;
	case MISSION_GO_TO_MAP_INTERSTELLAR: szString = L"MISSION_GO_TO_MAP_INTERSTELLAR"; break;
	case MISSION_GO_TO_MAP_PLASMA: szString = L"MISSION_GO_TO_MAP_PLASMA"; break;
	case MISSION_GO_TO_MAP_GALACTIC: szString = L"MISSION_GO_TO_MAP_GALACTIC"; break;
	case MISSION_GO_TO_MAP_MILKY_WAY: szString = L"MISSION_GO_TO_MAP_MILKY_WAY"; break;
	case MISSION_GO_TO_MAP_UNIVERSAL: szString = L"MISSION_GO_TO_MAP_UNIVERSAL"; break;
	case MISSION_GO_TO_MAP_DISTANT: szString = L"MISSION_GO_TO_MAP_DISTANT"; break;
	case MISSION_GO_TO_MAP_HYPERSPACE: szString = L"MISSION_GO_TO_MAP_HYPERSPACE"; break;
#endif

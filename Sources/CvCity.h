...
class CvUnitSelectionCriteria
{
  public:
	CvUnitSelectionCriteria()
		: m_eUnitAI(NO_UNITAI), m_eIgnoreAdvisor(NO_ADVISOR), m_eHealUnitCombat(NO_UNITCOMBAT), m_eProperty(NO_PROPERTY), m_eVisibility(NO_INVISIBLE), m_bIgnoreNotUnitAIs(false), m_bIgnoreGrowth(false), m_bPropertyBeneficial(true), m_bNoNegativeProperties(false), m_bIsHealer(false), m_bIsCommander(false)
	{
	}
...
#define ADVISOR_MASK  0x07
	...
	CvUnitSelectionCriteria& UnitAI(UnitAITypes UnitAI)
	{
		m_eUnitAI = UnitAI;
		return *this;
	}
	CvUnitSelectionCriteria& IgnoreAdvisor(AdvisorTypes IgnoreAdvisor)
	{
		m_eIgnoreAdvisor = IgnoreAdvisor;
		return *this;
	}
	CvUnitSelectionCriteria& HealUnitCombat(UnitCombatTypes HealUnitCombat)
	{
		m_eHealUnitCombat = HealUnitCombat;
		return *this;
	}
	CvUnitSelectionCriteria& Property(PropertyTypes Property)
	{
		m_eProperty = Property;
		return *this;
	}
	CvUnitSelectionCriteria& Visibility(InvisibleTypes Visibility)
	{
		m_eVisibility = Visibility;
		return *this;
	}
	CvUnitSelectionCriteria& IgnoreNotUnitAIs(bool IgnoreNotUnitAIs)
	{
		m_bIgnoreNotUnitAIs = IgnoreNotUnitAIs;
		return *this;
	}
	CvUnitSelectionCriteria& IgnoreGrowth(bool IgnoreGrowth)
	{
		m_bIgnoreGrowth = IgnoreGrowth;
		return *this;
	}
	CvUnitSelectionCriteria& PropertyBeneficial(bool PropertyBeneficial)
	{
		m_bPropertyBeneficial = PropertyBeneficial;
		return *this;
	}
	CvUnitSelectionCriteria& NoNegativeProperties(bool NoNegativeProperties)
	{
		m_bNoNegativeProperties = NoNegativeProperties;
		return *this;
	}
	CvUnitSelectionCriteria& IsHealer(bool IsHealer)
	{
		m_bIsHealer = IsHealer;
		return *this;
	}
	CvUnitSelectionCriteria& IsCommander(bool IsCommander)
	{
		m_bIsCommander = IsCommander;
		return *this;
	}
};
...
class CvCity : public CvDLLEntity
{
  ...
  public:
	...
	{
		ScoredBuilding(BuildingTypes building = NO_BUILDING, int score = -1)
			: building(building), score(score) {}

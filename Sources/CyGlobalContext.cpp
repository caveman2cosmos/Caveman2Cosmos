...
const CvMapInfo* CyGlobalContext::getMapInfo(int iMap) const
{
...
const CvMapCategoryInfo* CyGlobalContext::getMapCategoryInfo(int i) const
{
	return (i>=0 && i<GC.getNumMapCategoryInfos()) ? &GC.getMapCategoryInfo((MapCategoryTypes)i) : NULL;
}

const CvIdeaClassInfo* CyGlobalContext::getIdeaClassInfo(int i) const
{
	return (i>=0 && i<GC.getNumIdeaClassInfos()) ? &GC.getIdeaClassInfo((IdeaClassTypes)i) : NULL;
}

const CvIdeaInfo* CyGlobalContext::getIdeaInfo(int i) const
{
...
const CvAutomateInfo* CyGlobalContext::getAutomateInfo(int i) const
{
...
const CvInfoBase* CyGlobalContext::getHints(int i) const
{
...
const CvInvisibleInfo* CyGlobalContext::getInvisibleInfo(int i) const
{
...
const CvPlayerOptionInfo* CyGlobalContext::getPlayerOptionsInfoByIndex(int i) const
{
	return &GC.getPlayerOptionInfo((PlayerOptionTypes) i);
}


const CvGraphicOptionInfo* CyGlobalContext::getGraphicOptionsInfoByIndex(int i) const
{
...
const CvInfoBase* CyGlobalContext::getCityTabInfo(int i) const
{
...
const CvInfoBase* CyGlobalContext::getMonthInfo(int i) const
{
...
const CvQuestInfo* CyGlobalContext::getQuestInfo(int i) const
{
	return (i>=0 && i<GC.getNumQuestInfos()) ? &GC.getQuestInfo(i) : NULL;
}


const CvTutorialInfo* CyGlobalContext::getTutorialInfo(int i) const
{
...
const CvArtInfoLeaderhead* CyGlobalContext::getLeaderheadArtInfo(int i) const
{
...
const CvArtInfoTerrain* CyGlobalContext::getTerrainArtInfo(int i) const
{
	return (i>=0 && i<ARTFILEMGR.getNumTerrainArtInfos()) ? &ARTFILEMGR.getTerrainArtInfo(i) : NULL;
}


const CvArtInfoFeature* CyGlobalContext::getFeatureArtInfo(int i) const
{
...
const CvTurnTimerInfo* CyGlobalContext::getTurnTimerInfo(int i) const
{

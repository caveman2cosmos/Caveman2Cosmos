...
class CvWString : public std::wstring
{
  public:
	...
	CvWString&	operator=(const wchar* s)
	{
		if (s)
			assign(s);
		else
	...
	CvWString& operator=(const std::wstring& s)
	{
		assign(s.c_str());
		return *this;
	}
	CvWString& operator=(const std::string& w)
	{
		Copy(w.c_str());
		return *this;
	}
	CvWString& operator=(const CvWString& w)
	{
		assign(w.c_str());
		return *this;
	}
#ifndef _USRDLL
	// FString conversion, if not in the DLL
	CvWString& operator=(const FStringW& s)
	{
		assign(s.GetCString());
		return *this;
	}
	CvWString& operator=(const FStringA& w)
	{
		Copy(w.GetCString());
		return *this;
	}
#endif
	CvWString& operator=(const char* w)
	{
		Copy(w);
		return *this;
	}
...
inline CvWString operator+(const CvWString& s, const CvWString& t)
{
	return CvWString((std::wstring&)s + (std::wstring&)t);
}
inline CvWString operator+(const CvWString& s, const wchar* t)
{
	return CvWString((std::wstring&)s + std::wstring(t));
}
inline CvWString operator+(const wchar* s, const CvWString& t)
{
	return CvWString(std::wstring(s) + std::wstring(t));
}
...
class CvString : public std::string
{
  public:
	...
	const CvString& operator=(const char* s)
	{
		if (s)
			assign(s);
		else
	...
	const CvString& operator=(const std::string& s)
	{
		assign(s.c_str());
		return *this;
	}

...
CvPropertyInteraction::CvPropertyInteraction()
	: m_eSourceProperty(NO_PROPERTY), m_eTargetProperty(NO_PROPERTY), m_eObjectType(NO_GAMEOBJECT), m_eRelation(NO_RELATION), m_iRelationData(0), m_pExprActive(NULL)
{
}

CvPropertyInteraction::CvPropertyInteraction(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty)
	: m_eSourceProperty(eSourceProperty), m_eTargetProperty(eTargetProperty), m_eObjectType(NO_GAMEOBJECT), m_eRelation(NO_RELATION), m_iRelationData(0), m_pExprActive(NULL)
{
}
...
CvPropertyInteractionConvertConstant::CvPropertyInteractionConvertConstant()
	: CvPropertyInteraction(), m_iAmountPerTurn(0)
{
}

CvPropertyInteractionConvertConstant::CvPropertyInteractionConvertConstant(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iAmountPerTurn(0)
{
}

CvPropertyInteractionConvertConstant::CvPropertyInteractionConvertConstant(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty, int iAmountPerTurn)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iAmountPerTurn(iAmountPerTurn)
{
}
...
CvPropertyInteractionInhibitedGrowth::CvPropertyInteractionInhibitedGrowth()
	: CvPropertyInteraction(), m_iGrowthPercent(0), m_iInhibitionPercent(0)
{
}

CvPropertyInteractionInhibitedGrowth::CvPropertyInteractionInhibitedGrowth(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iGrowthPercent(0), m_iInhibitionPercent(0)
{
}

CvPropertyInteractionInhibitedGrowth::CvPropertyInteractionInhibitedGrowth(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty, int iGrowthPercent, int iInhibitionPercent)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iGrowthPercent(iGrowthPercent), m_iInhibitionPercent(iInhibitionPercent)
{
}
...
CvPropertyInteractionConvertPercent::CvPropertyInteractionConvertPercent()
	: CvPropertyInteraction(), m_iPercent(0), m_iNoConvertAmount(0)
{
}

CvPropertyInteractionConvertPercent::CvPropertyInteractionConvertPercent(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iPercent(0), m_iNoConvertAmount(0)
{
}

CvPropertyInteractionConvertPercent::CvPropertyInteractionConvertPercent(PropertyTypes eSourceProperty, PropertyTypes eTargetProperty, int iPercent, int iNoConvertAmount)
	: CvPropertyInteraction(eSourceProperty, eTargetProperty), m_iPercent(iPercent), m_iNoConvertAmount(iNoConvertAmount)
{
}

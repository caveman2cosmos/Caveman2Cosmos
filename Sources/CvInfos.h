...
public:
	...
	const PrereqBuildingClass& getPrereqBuildingClass(int iIndex) const;
	...
	const PrereqBuildingClass& getPrereqOrBuildingClass(int iIndex) const;
...
public:
	...
	const FreeTraitTypes& getFreeTraitType(int iIndex) const;

...
handle_t hIServerUtilsBinding;


static const RPC_CLIENT_INTERFACE IServerUtils___RpcClientInterface =
    {
...
RPC_IF_HANDLE IServerUtils_v1_0_c_ifspec = (RPC_IF_HANDLE)& IServerUtils___RpcClientInterface;
...
static const MIDL_STUB_DESC IServerUtils_StubDesc = 
    {
    (void *)& IServerUtils___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hIServerUtilsBinding,
    0,
    0,
    0,
    0,

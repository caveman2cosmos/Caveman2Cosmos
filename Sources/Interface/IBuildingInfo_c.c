...
static const RPC_CLIENT_INTERFACE IBuildingInfo___RpcClientInterface =
    {
...
RPC_IF_HANDLE IBuildingInfo_v1_0_c_ifspec = (RPC_IF_HANDLE)& IBuildingInfo___RpcClientInterface;

extern const MIDL_STUB_DESC IBuildingInfo_StubDesc;

static RPC_BINDING_HANDLE IBuildingInfo__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t hBinding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IBuildingInfo_StubDesc,
                  (PFORMAT_STRING) &IBuildingInfo__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&hBinding);
    return ( hIBuildingInfo_t  )_RetVal.Pointer;
    ...
    /* [in] */ hIBuildingInfo_t hBuilding)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IBuildingInfo_StubDesc,
                  (PFORMAT_STRING) &IBuildingInfo__MIDL_ProcFormatString.Format[34],
                  ( unsigned char * )&hBuilding);
    ...
    /* [in] */ hIBuildingInfo_t hBuilding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IBuildingInfo_StubDesc,
                  (PFORMAT_STRING) &IBuildingInfo__MIDL_ProcFormatString.Format[70],
                  ( unsigned char * )&hBuilding);
    ...
    /* [in] */ boolean b)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IBuildingInfo_StubDesc,
                  (PFORMAT_STRING) &IBuildingInfo__MIDL_ProcFormatString.Format[112],
                  ( unsigned char * )&hBuilding);
...
static const MIDL_STUB_DESC IBuildingInfo_StubDesc = 
    {
    (void *)& IBuildingInfo___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IBuildingInfo__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,

...
m_iAI_VALUE_PER_BUILDING_FOR_UNITS(0),
...
/************************************************************************************************/
	...
	m_iAI_VALUE_PER_BUILDING_FOR_UNITS = getDefineINT("AI_VALUE_PER_BUILDING_FOR_UNITS");
...
int cvInternalGlobals::getAI_VALUE_PER_BUILDING_FOR_UNITS()
{
	return m_iAI_VALUE_PER_BUILDING_FOR_UNITS;
}

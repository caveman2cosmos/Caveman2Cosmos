...
void cvInternalGlobals::registerMissions()
{
	...
	REGISTER_MISSION(MISSION_GO_TO_MAP_MOON);
	REGISTER_MISSION(MISSION_GO_TO_MAP_MARS);
	REGISTER_MISSION(MISSION_GO_TO_MAP_VENUS);
	REGISTER_MISSION(MISSION_GO_TO_MAP_INNER_SOLAR_SYSTEM);
	REGISTER_MISSION(MISSION_GO_TO_MAP_OUTER_SOLAR_SYSTEM);
	REGISTER_MISSION(MISSION_GO_TO_MAP_TITAN);
	REGISTER_MISSION(MISSION_GO_TO_MAP_TRANSNEPTUNIAN);
	REGISTER_MISSION(MISSION_GO_TO_MAP_NEARBY_STARS);
	REGISTER_MISSION(MISSION_GO_TO_MAP_ORION_ARM);
	REGISTER_MISSION(MISSION_GO_TO_MAP_MILKY_WAY);
	REGISTER_MISSION(MISSION_GO_TO_MAP_LOCAL_GROUP);
	REGISTER_MISSION(MISSION_GO_TO_MAP_VIRGO_SUPERCLUSTER);
	REGISTER_MISSION(MISSION_GO_TO_MAP_UNIVERSE);
	REGISTER_MISSION(MISSION_GO_TO_MAP_DISTANT_COSMOS);
#endif
}

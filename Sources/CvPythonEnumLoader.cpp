...
// BUG - Sentry Actions - end
	...
	boost::python::enum_<ModderGameOptionTypes>("ModderGameOptionTypes")
		...
		.value("MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_MIN_DIFFICULTY", MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_MIN_DIFFICULTY)
		.value("MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_MAX_DIFFICULTY", MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_MAX_DIFFICULTY)
		.value("MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_TURN_INCREMENTS", MODDEROPTION_FLEXIBLE_DIFFICULTY_AI_TURN_INCREMENTS)
